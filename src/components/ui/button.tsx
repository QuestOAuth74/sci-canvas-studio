  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium smooth-transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        glass: "bg-secondary border border-border text-foreground shadow-sm hover:bg-secondary/80 hover:shadow-md hover:scale-[1.02] active:scale-[0.98]",
        sticky: "bg-accent text-accent-foreground shadow-sm hover:bg-accent/90 hover:shadow-md hover:scale-[1.02] active:scale-[0.98]",
        ink: "bg-primary text-primary-foreground shadow-sm hover:bg-primary/90 hover:shadow-md hover:scale-[1.02] active:scale-[0.98]",
        pencil: "border-2 border-border bg-background text-muted-foreground hover:bg-muted hover:border-foreground/50 hover:scale-[1.02] active:scale-[0.98] shadow-sm",
      },
      size: {
